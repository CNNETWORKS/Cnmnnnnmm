...
async def batch_link(_, message):
    ...
    join_button = InlineKeyboardButton("Join Channel", url="https://t.me/cnnetworkofficial")
    keyboard = InlineKeyboardMarkup([[join_button]])
    pin_msg = await app.send_message(
        user_id,
        f"Batch process started ⚡\nProcessing: 0/{cl}\n\n**Powered by @cnnetworkofficial Botz**",
            ...
            if user_id in users_loop and users_loop[user_id]:
                ...
                if 't.me/' in link and not any(x in link for x in ['t.me/b/', 't.me/c/', 'tg://openmessage']):
                    ...
                    await pin_msg.edit_text(
                        f"Batch process started ⚡\nProcessing: {i - cs + 1}/{cl}\n\n**__Powered by @cnnetworkofficial Botz__**",
                        reply_markup=keyboard
                    )
        ...
        for i in range(cs, cs + cl):
            ...
            if user_id in users_loop and users_loop[user_id]:
                ...
                if any(x in link for x in ['t.me/b/', 't.me/c/']):
                    ...
                    await process_and_upload_link(userbot, user_id, msg.id, link, 0, message)
                    await pin_msg.edit_text(
                        f"Batch process started ⚡\nProcessing: {i - cs + 1}/{cl}\n\n**__Powered by @cnnetworkofficial__**",
                        reply_markup=keyboard
                    )
