...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("🆘 Report Errors", "https://t.me/cnnetworkofficial")]
    ]
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/jioxt")]
                ]
            )
...
def progress_callback(done, total, user_id):
    ...
    final = (
        ...
        f"╰──────────────────╯\n\n"
        f"**__Powered by @cnnetworkofficial Botz__**"
    )
